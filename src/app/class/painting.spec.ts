...
describe(`Painting testing`,()=>{
    let statue:Painting;
    beforeEach(()=>
    statue=new Painting("4", "1", 100, "Зевс", 1800, 'Англія', 'Джек Лондон', 'Античність'));
    ...
    it("Створення екземпляру класу Картина з від'ємною ціною price",()=>{
        expect(()=> new Painting("4","1", -100, "Зевс", 1800, 'Англія', 'Джек Лондон', 'Античність')).toThrow(new Error('Неправильний формат price'));
    });
    it("Створення екземпляру класу Картина з від'ємною роком year",()=>{
        expect(()=> new Painting("4","1", 100, "Зевс", -1800, 'Англія', 'Джек Лондон', 'Античність')).toThrow(new Error('year<0'));
    });
